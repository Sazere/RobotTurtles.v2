...
public class Game {
	...
	/*public void defausser() {
		System.out.println("Voulez-vous dÃ©fausser le reste de vos cartes ?");
		...
		default:
			System.out.println("Veuillez rÃ©pondre par oui ou par non.");
			defausser();
			}
		}*/
	/*public void completerProgramme() {
		System.out.println(joueurs.get(compteur-1).getMain());
		System.out.println("Quelle carte souhaitez-vous ajouter Ã  votre programme ?");
		System.out.println("(1) PremiÃ¨re carte \n(2) DeuxiÃ¨me Carte \n(3) TroisiÃ¨me carte \n(4) QuatriÃ¨me carte \n(5) CinquiÃ¨me carte");
		int choixCarte = scanner.nextInt();
		switch(choixCarte) {
		case 1:
			joueurs.get(compteur-1).getProgramme().add(joueurs.get(compteur-1).getMain().get(0));
